  ...
  async (req, res) => {
    try {
      ...
      if (participantError) {
        ...
        console.error(
          "Erreur récupération compte pour suppression :",
          participantError
        );
      ...
      // ========================================
      // SUPPRIMER RÉCOMPENSES
      // ========================================

      const {
        error: rewardsDeleteError,
      } = await supabase
        .from("Recompenses")
        .delete()
        .eq(
      ...
      if (rewardsDeleteError) {
        ...
        console.error(
          "Erreur suppression récompenses :",
          rewardsDeleteError
        );
      ...
      // ========================================
      // SUPPRIMER PARRAINAGE EN TANT QUE FILLEUL
      // ========================================

      const {
        error: referralsAsChildError,
      } = await supabase
        .from("Parrainages")
        .delete()
        .eq(
      ...
      if (referralsAsChildError) {

        console.error(
          "Erreur suppression parrainage filleul :",
          referralsAsChildError
        );
      ...
      // ========================================
      // SUPPRIMER PARRAINAGES EN TANT QUE PARRAIN
      // ========================================

      if (
        participant.code_parrain
      ) {

        const {
          error:
            referralsAsSponsorError,
        } = await supabase
          .from("Parrainages")
          .delete()
          .eq(
        ...
        if (
          ...
          console.error(
            "Erreur suppression parrainages parrain :",
            referralsAsSponsorError
          );
